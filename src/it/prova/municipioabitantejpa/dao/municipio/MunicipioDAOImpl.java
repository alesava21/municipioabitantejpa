...
public class MunicipioDAOImpl implements MunicipioDAO {
	...
	public List<Municipio> findAllByDescrizioneIniziaCon(String iniziale) throws Exception {
		if (iniziale == null) {
			throw new Exception("valore iniziale non valido");
		}

		TypedQuery<Municipio> query = entityManager.createQuery("select distinct m from Municipio m where m.descrizione like ?1",
				Municipio.class);
